...
`prompts/` 按电商 9 图的营销职责管理 Prompt 资产。根级编号文件保存模型无关的标准 Prompt 模板；同名分类目录保存人类可读的阶段规则和未来品类变体。两者均与 [`../docs/ecommerce_image_system_v2.md`](../docs/ecommerce_image_system_v2.md) 保持一致。
...
| --- | --- | --- |
| 01 | `01_stop_scroll.md` | `stop_scroll/` | 主图，吸引停留与点击 |
| 02 | `02_explain.md` | `explain/` | 卖点图，解释购买理由 |
| 03 | `03_choose.md` | `choose/` | SKU 图，帮助选择 |
| 04 | `04_desire.md` | `desire/` | 效果图，激发购买欲 |
| 05 | `05_quality.md` | `quality/` | 细节图，证明品质 |
| 06 | `06_use.md` | `use/` | 使用图，证明易用性 |
| 07 | `07_aspire.md` | `aspire/` | 向往图，建立身份认同 |
| 08 | `08_premium.md` | `premium/` | 价值图，提升感知价值 |
| 09 | `09_trust.md` | `trust/` | 信任图，消除购买顾虑 |
...
| 文件 | 用途 | 状态 |
| --- | --- | --- |
| `prompts/01_*.md`–`09_*.md` | 标准 System Prompt、用户模板、变量、输出与负面约束 | 已建立 |
...
- 规则目录使用小写 `snake_case`，不加顺序数字；根级 Prompt 使用 `01_`–`09_` 固定编号。
